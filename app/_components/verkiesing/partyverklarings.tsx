...
import { partyLogo, type Partyverklaring } from "@/lib/verkiesing/partye";
 ...
 * sits in the same fixed square; the card itself carries no party colour or red, and never
 * says which party published most recently. The whole card opens the statement's own page
