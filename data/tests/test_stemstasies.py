...
def test_nc451_wyk_id_versameling_collects_by_ward_number():
    ...
    resultaat = ls.nc451_wyk_id_versameling(stasie_rye)
...
def test_bou_nc451_wyk_rye_maps_cleanly(monkeypatch):
    monkeypatch.setattr(ls.geo, "na_ewkt_4326", lambda vorm, epsg: f"SRID=4326;{vorm.naam}")
    ...
    rye, gapings = ls.bou_nc451_wyk_rye(nc451_wyk_ids, vorm_rekord_pare)
